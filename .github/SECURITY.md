...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/krl/security/advisories/new)
...
- This repository (`hyperpolymath/krl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/krl/security/advisories)
...
*Thank you for helping keep KRL and its users safe.* 🛡️
