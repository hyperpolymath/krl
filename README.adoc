...
image:https://api.securityscorecards.dev/projects/github.com/hyperpolymath/krl/badge[OpenSSF Scorecard, link="https://securityscorecards.dev/viewer/?uri=github.com/hyperpolymath/krl"]

[TIP]
====
**AI-Assisted Install:** Just tell any AI assistant: +
`Set up KRL from https://github.com/hyperpolymath/krl` +
...
If you're curious about the tech behind the claims in this README, see
link:EXPLAINME.adoc[EXPLAINME.adoc] — feature highlights with code paths
and honest caveats. Questions welcome via issues or direct contact.

== Documentation

* link:EXPLAINME.adoc[Show Me The Receipts] — how headline features work
