...
|===
|File |Demonstrates
|`+trefoil.krl+` |CONSTRUCT (sigma), RESOLVE (close), TRANSFORM (mirror,
simplify)

|`+figure_eight.krl+` |CONSTRUCT with alternating crossings, amphichiral
mirror
...
See `+../spec/grammar.ebnf+` for the formal grammar and
`+../spec/grammar-overview.md+` for an introduction.
