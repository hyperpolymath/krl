...
#
# KRL — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: krl-release)
...
CT_KEY_ID="${CT_KEY_ID:-krl-release}"
...
echo "=== KRL Cerro Torre Build Pipeline ==="
