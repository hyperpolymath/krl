...
krl and QuandleDB share the equivalence-integrity spine. *VerisimCore placement
is now resolved* (maintainer-confirmed 2026-06-19: krl → tangle/TangleIR →
VerisimCore (categorical abstraction) → Skein/QuandleDB). Once the remaining open
items resolve — the language-family split; the query-language decision — update
the canonical copy in quandledb and re-sync this duplicate.
====
